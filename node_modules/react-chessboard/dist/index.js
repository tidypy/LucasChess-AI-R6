...
function ChessboardProvider({ children, options, }) {
    ...
    // handlers
    canDragPiece, onArrowsChange, onMouseOutSquare, onMouseOverSquare, onPieceClick, onPieceDrag, onPieceDragCancel, onPieceDrop, onSquareClick, onSquareMouseDown, onSquareMouseUp, onSquareRightClick, squareRenderer, } = options || {};
        ...
        if (newArrowStartSquare && newArrowStartSquare !== newArrowEndSquare) {
            ...
            if (arrowOptions.colors) {
                if (modifiers?.altKey && arrowOptions.colors.alt)
                    ...
                    arrowColor = arrowOptions.colors.default || arrowOptions.color;
            }
            else {
                // TODO: remove support for legacy arrow color props in future breaking version
    ...
    const setNewArrowOverSquareWithModifiers = React.useCallback((square, modifiers) => {
        ...
        if (arrowOptions.colors) {
            if (modifiers?.altKey && arrowOptions.colors.alt)
                ...
                color = arrowOptions.colors.default || arrowOptions.color;
        }
        else {
            // TODO: remove support for legacy arrow color props in future breaking version
...
const Piece = React.memo(function Piece({ clone, isSparePiece = false, position, pieceType, }) {
    ...
    return (jsxRuntime.jsx("div", { id: `${id}-piece-${pieceType}-${position}`, "data-piece": pieceType, style: {
        ...
        }, onClick: () => onPieceClick?.({ isSparePiece, piece: { pieceType }, square: position }), children: jsxRuntime.jsx(PieceSvg, { square: position }) }));
});
...
const Square = React.memo(function Square({ children, squareId, isLightSquare, isOver, }) {
    ...
    const [isClickingOnMobile, setIsClickingOnMobile] = React.useState(false);
...
exports.isTouchEndWithinSquare = isTouchEndWithinSquare;
