...
class Manifest(XML.XML):
    def __init__(self):
        ...
        element2.add_param(
            "rdf:resource",
            "https://docs.oasis-open.org/ns/office/1.2/meta/odf#StylesFile",
        )
        ...
        element4.add_param("xmlns:ns0", "https://docs.oasis-open.org/ns/office/1.2/meta/pkg#")
        ...
        element6.add_param(
            "rdf:resource",
            "https://docs.oasis-open.org/ns/office/1.2/meta/odf#ContentFile",
        )
        ...
        element8.add_param("xmlns:ns0", "https://docs.oasis-open.org/ns/office/1.2/meta/pkg#")
        ...
        element10.add_param("rdf:resource", "https://docs.oasis-open.org/ns/office/1.2/meta/pkg#Document")
...
class Meta(XML.XML):
    def __init__(self):
        ...
        element1.add_content(
            element3
        )  # element4 = XML.Element("meta:generator")  # element1.add_content(element4)  # element4.set_value("Lucas Chess")
