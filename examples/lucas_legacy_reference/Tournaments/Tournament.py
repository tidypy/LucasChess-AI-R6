...
class EngineTournament(Engines.Engine):
    ...
    def read_exist_engine(self, resp):
        cm = Code.configuration.engines.search(resp)
...
class GameTournament(object):
    def __init__(self):
        ...
        self.hblack: str | None = None  # la huella de un engine
...
class Tournament:
    ...
    def remove_engine(self, engine: EngineTournament):
        li_rem_gm = []
        huella = engine.huella
        gm: GameTournament
        ...
        del self.db_engines[engine.huella]
