...
class WSwissConfig(LCDialog.LCDialog):
    def __init__(self, w_parent, swiss: Swiss.Swiss):
        ...
        for widget in (
            ...
            self.ed_draw_range,
            bt_draw_range,
            self.ed_draw_min_ply,
            self.cb_jmotor,
            self.ed_jtiempo,
            self.ed_minutes_eng_eng,
            self.sb_seconds_eng_eng,
            self.ed_minutes_eng_human,
            self.sb_seconds_eng_human,
            self.ed_score_win,
            self.ed_score_draw,
            self.ed_score_lost,
            self.ed_score_byes,
    ...
    def read():
        li = []
        carpeta = Code.configuration.paths.folder_Swisses()
