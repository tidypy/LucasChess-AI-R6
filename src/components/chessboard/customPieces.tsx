...
export type CustomPieceProps = {
  fill?: string;
  square?: string;
  svgStyle?: CSSProperties;
};

export type PieceRenderObject = Record<string, (props?: CustomPieceProps) => JSX.Element>;

/**
 * Standard High-Definition Vector Chess Pieces.
 * Fixes the disconnected White Bishop (wB) pedestal artifact where the base
 * appeared as a floating line on dark squares due to a transparent gap in the SVG path.
 */
export const customChessPieces: PieceRenderObject = {
  wP: (props?: CustomPieceProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 45 45" width="100%" height="100%" style={props?.svgStyle}>
      <path
    ...
    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 45 45" width="100%" height="100%" style={props?.svgStyle}>
      ...
      >
        <g style={{ fill: props?.fill ?? "#ffffff", stroke: "#000000", strokeLinecap: "butt" }}>
          {/* Seamless Unified Body + Base to prevent floating pedestal gap */}
          <path d="M 9,36 C 12.39,35.03 19.11,36.43 22.5,34 C 25.89,36.43 32.61,35.03 36,36 C 36,36 37.65,36.54 39,38 C 38.32,38.97 37.35,38.99 36,38.5 C 32.61,37.53 25.89,38.96 22.5,37.5 C 19.11,38.96 12.39,37.53 9,38.5 C 7.65,38.99 6.68,38.97 6,38 C 7.35,36.54 9,36 9,36 z" />
          <path d="M 15,36 L 15,32 C 17.5,34.5 27.5,34.5 30,32 L 30,36 C 30,36 27.5,36 22.5,35.5 C 17.5,36 15,36 15,36 z" style={{ stroke: "none" }} />
