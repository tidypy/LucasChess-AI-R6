...
from Code.QT import FormLayout, Iconos, QTDialogs, QTMessages
...
class ShortCuts:
    ...
    def launch_menu(self):
        ...
        rondo = QTDialogs.rondo_puntos(False)
        menu = QTDialogs.LCMenu(self.wlines)
        ...
        if resp == "rem_all":
            ...
            if QTMessages.pregunta(self.wlines, _("Are you sure you want to remove %s?") % name):
                del self.li_shortcuts[pos]
                self.reset()
                return
        else:
