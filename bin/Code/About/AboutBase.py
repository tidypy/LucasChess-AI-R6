...
class ThanksTo:
    ...
    def images(self):
        ...
        li = [
            (
                "Nuvola",
                "David Vignoni",
                "https://www.icon-king.com/projects/nuvola/",
                "LGPL",
            ),
            (
                "Icons for Windows8",
            ...
            (
                "Wooicons1",
                "Janik Baumgartner",
                "https://www.woothemes.com/2010/08/woocons1/",
                "GPL",
            ),
            (
            ...
            (
                "SnowIsh SVG",
                "Saki",
                "https://gnome-look.org/content/show.php/SnowIsh+SVG+%26+PNG?content=32599",
                "GPL",
            ),
            (
    ...
    def themes(self):
        ...
        li = [
            (
                "Armani Closet",
                "mimi22",
                "https://www.colourlovers.com/palette/117475/armani_closet",
            ),
            (
                "Chocolate Creams",
                "Skyblue2u",
                "https://www.colourlovers.com/palette/582195/Chocolate_Creams",
            ),
            (
                "Good Friends",
                "Yasmino",
            ...
            (
                "Nectarius",
                "note",
                "https://www.colourlovers.com/palette/1897208/nectarius",
            ),
            (
                "Trajan",
                "Jaime Guadagni aka The Cooler",
                "https://www.colourlovers.com/palette/67170/Trajan",
            ),
        ]
    ...
    def pieces(self):
        ...
        li = [
            (
                "ChessiconsV3.5",
                '<a href="https://www.virtualpieces.net">Peter Wong</a>',
                _("Permission of author"),
            ),
            (
                "Merida-Internet",
                '<a href="https://www.rybkachess.com">Felix Kling</a>',
                _("Permission of author"),
            ),
            (
            ...
            (
                "Chess Pirat",
                '<a href="https://www.enpassant.dk/chess/fonteng.htm">Klaus Wolf</a>',
                _("Freeware"),
            ),
            (
                "Chess Regular",
                '<a href="https://www.enpassant.dk/chess/fonteng.htm">Alastair Scott</a>',
                _("Freeware"),
            ),
            (
                "Chess Regular2",
    ...
    def programming(self):
        li = (
            ...
            (_("GUI"), "PySide6", "https://wiki.qt.io/Qt_for_Python", "LGPLv3"),
            (
                "psutil",
                _X(_("Created by %1"), "Giampaolo Rodola"),
                "https://github.com/giampaolo/psutil",
                "BSD License (BSD-3-Clause)",
            ),
            (
                "charset-normalizer",
                _X(_("Created by %1"), "Ahmed R. TAHRI"),
            ...
            (
                "python-chess",
                _X(_("Created by %1"), "Niklas Fiekas"),
            ...
            (
                "formlayout",
                _X(_("Created by %1"), "Pierre Raybaut"),
