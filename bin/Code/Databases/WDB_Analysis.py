...
class DBAnalysis:
    def __init__(self):
        self.db = UtilSQL.DictSQL(Code.configuration.paths.file_analysis(), tabla="analysis", max_cache=1024)
...
class WDBAnalisis:
    ...
    def menu(self, pv):
        ...
        if resp == "an_new":
            ...
            num = int(resp[7:])
            if QTMessages.pregunta(self.wowner, _X(_("Delete analysis of %1?"), li_analisis[num].rotulo)):
