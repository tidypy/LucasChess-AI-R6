...
class WThemes(LCDialog.LCDialog):
    def __init__(self, owner, current_move: Move.Move):
        ...
        self.qt_custom = ScreenUtils.qt_color("#bf5b16")
    ...
    def change_abbreviation(self, theme_key):
        ...
        new = QTMessages.read_simple(self, _("Change abbreviation"), _("Abbreviation"), abbr)
        if new is None:
            return
    ...
    def add_custom(self):
        txt_custom = QTMessages.read_simple(self, _("Add a custom theme"), _("Name"), "")
