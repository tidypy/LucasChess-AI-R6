...
class Bloque:
    ...
    def tipoqt(self):
        return {
            ...
            5: QtCore.Qt.PenStyle.DashDotDotLine,
            0: QtCore.Qt.PenStyle.NoPen,
        }.get(self.tipo, QtCore.Qt.PenStyle.SolidLine)
    ...
    def __init__(self):
        li_vars = [
            ...
            (
                ...
                "n",
                1,
            ),  # 1=SolidLine, 2=DashLine, 3=DotLine, 4=DashDotLine, 5=DashDotDotLine, 0=Sin borde
        ]
        Bloque.__init__(self, li_vars)
    ...
    def __init__(self, dic=None):
        li_vars = [
            ...
            (
                ...
                "n",
                1,
            ),  # 1=SolidLine, 2=DashLine, 3=DotLine, 4=DashDotLine, 5=DashDotDotLine
...
class Pizarra(QtWidgets.QWidget):
    def __init__(self, guion, board, ancho, edit_mode=False, with_continue=False):
        ...
        self.setWindowFlags(QtCore.Qt.WindowType.WindowCloseButtonHint | QtCore.Qt.WindowType.ToolTip)
