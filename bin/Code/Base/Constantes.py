...
ST_PLAYING, ST_ENDGAME, ST_WAITING, ST_PAUSE, ST_TUTOR_THINKING = range(5)
...
RESULT_UNKNOWN, RESULT_WIN_WHITE, RESULT_WIN_BLACK, RESULT_DRAW = (
    "*",
    "1-0",
    "0-1",
    "1/2-1/2",
...
ZVALUE_PIECE, ZVALUE_PIECE_MOVING = 10, 100
...
KIBRUN_CONFIGURATION, KIBRUN_GAME, KIBRUN_CLOSE, KIBRUN_COPYCLIPBOARD, KIBRUN_STOP = (
    "C",
    "F",
    "T",
    "B",
...
FENM2_INITIAL = "rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq -"

PHASE_NODEFINED, OPENING, MIDDLEGAME, ENDGAME, ALLGAME = range(5)
...
FIRST_BEST_MOVE, ALL_BEST_MOVES, ALL_MOVES, TOP2_FIRST_MOVES, TOP3_FIRST_MOVES = (
    "1B",
    "AB",
    "A",
    "2B",
...
RUNA_CONFIGURATION, RUNA_GAME, RUNA_TERMINATE, RUNA_HALT, RUNA_PAUSE, RUNA_RESUME, RUNA_PROGRESS = (
    "C",
    "G",
    "T",
    "H",
...
PZ_VALUES = {"R": 5, "Q": 10, "B": 3, "N": 3, "P": 1, "K": 0}

DBSHOW_INITIAL_POSITION, DBSHOW_FIRST_MOVE, DBSHOW_LAST_MOVE = range(3)

COL_WHITE, COL_BLACK, COL_NUMBER = "WHITE", "BLACK", "NUMBER"

INFINITE = 2147483646
INFINITE_FLOAT = sys.float_info.max

MULTIPV_MAXIMIZE, MULTIPV_BYDEFAULT = "MX", "PD"

NOTATION_ALGEBRAIC, NOTATION_LONGALGEBRAIC, NOTATION_DESCRIPTIVE = "A", "L", "D"

(HIGHLIGHT_STYLE_ARROW,
 HIGHLIGHT_STYLE_ARROW_CURVED,
 HIGHLIGHT_STYLE_OUTLINE,
 HIGHLIGHT_STYLE_FILL,
 HIGHLIGHT_STYLE_NONE) = "A", "C", "O", "F", "N"

TIMEMODE_SUDDEN_DEATH = 1
TIMEMODE_FISCHER = 2
TIMEMODE_BRONSTEIN = 3
TIMEMODE_DELAY_SIMPLE = 4
TIMEMODE_HOURGLASS = 5
TIMEMODE_MOVES_IN_TIME = 6
TIMEMODE_HANDICAP = 7
