...
def pmAIChip():
    ...
    path = Code.path_resource("IntFiles", "ai_chip_icon.png")
    if os.path.exists(path):
        return QtGui.QPixmap(path)
    if os.path.exists("ai_chip_icon.png"):
        return QtGui.QPixmap("ai_chip_icon.png")
    return iget("pmTutor")
...
def pmSalvavidas():
    return iget("pmSalvavidas")

def Salvavidas():
    return iget("Salvavidas")
...
def pmStopTraining():
    return iget("pmStopTraining")

def StopTraining():
    return iget("StopTraining")
...
def pmPauseColor():
    return iget("pmPauseColor")

def PauseColor():
    return iget("PauseColor")

def pmContinueColor():
    return iget("pmContinueColor")

def ContinueColor():
    return iget("ContinueColor")
...
def pmHeight():
    return iget("pmHeight")

def Height():
    return iget("Height")

def pmAbreviatura():
    return iget("pmAbreviatura")

def Abreviatura():
    return iget("Abreviatura")

def pmOptions():
    return iget("pmOptions")

def Options():
    return iget("Options")

def pmCompetitions():
    return iget("pmCompetitions")

def Competitions():
    return iget("Competitions")

def pmSaveAs():
    return iget("pmSaveAs")

def SaveAs():
    return iget("SaveAs")

def pmProgreso():
    return iget("pmProgreso")
